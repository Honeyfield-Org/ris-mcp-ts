...
- `ris_dokument_abschnitt` deklariert `outputSchema`/`structuredContent`, obwohl `ris_dokument` das bewusst nicht tut — der v1.3.0-Befund traf Metadaten-`structuredContent`, das den Volltext verdrängte; hier **ist** der Chunk-Text Teil des strukturierten Payloads, ein Client verliert also nichts (#51).
